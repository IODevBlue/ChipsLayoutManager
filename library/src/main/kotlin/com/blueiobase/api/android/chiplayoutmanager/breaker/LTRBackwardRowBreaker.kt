...
/**
 * This class is responsible for breaking the [View] object anchored at the right/end for the [LTRRowBreakerFactory].
 *
 * @author IO DevBlue
 * @since 1.0.0
 *
...
class LTRBackwardRowBreaker: ILayoutRowBreaker {
    ...
    override fun isRowBroke(abstractLayouter: AbstractLayouter) = (abstractLayouter.viewRight - abstractLayouter.currentViewWidth < abstractLayouter.getCanvasLeftBorder()
